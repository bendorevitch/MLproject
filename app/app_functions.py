...
class app_functions():
    def get_scoreboard(self):
        ...
        self.game_dates= ("ScoreBoardDate: " + board.score_board_date)
        ...
        for game in games:
            ...
            self.today_games.append([gameId, awayTeam, homeTeam, gameTimeLTZ])
        print(self.game_dates)
        print(self.today_games)
    
    box = boxscore.BoxScore('0022300550') 
